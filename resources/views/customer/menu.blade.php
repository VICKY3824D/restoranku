                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="rounded position-relative fruite-item">
                                    <div class="fruite-img">
                                        <img src="{{ $item->img }}" class="img-fluid w-100 rounded-top" alt="{{ $item->name }}" onerror="this.onerror=null;this.src='{{ $item->img }}';">
                                    </div>
...
<script>
    function addToCart(menuId) {
        console.log('Adding item to cart, ID:', menuId); // Debug log
